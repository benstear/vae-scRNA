...
print('Beginning the 13,313 cell dataset...\n...')
...
def plot2D(X,y,method,title,time_elapsed):
    ...
    #################3#fig.savefig('/scr1/users/stearb/results/plots_13313/'+method+'__'+str(np.float16(time_elapsed))+'.png')
...
#labels13k = pd.read_csv('/Users/stearb/desktop/vae-scRNA-master/data/n_13313_singlenuc/metadata_singleNuc_13k.txt',sep='\t')
...
print('tsne time = %s ' % time_elapsed)
