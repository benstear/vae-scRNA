...
start = time.time()
tsne = TSNE(n_components=n_components,learning_rate=100)
...
t = time.time()
iso = manifold.Isomap(n_neighbors, n_components, eigen_solver='auto')
...
t = time.time()
spectral = manifold.SpectralEmbedding(n_components=2, random_state=0,eigen_solver='amg')
